    ...
    <div class="row">
        <div class="col-12">
            <h1 class="h3 mb-4">
                ...
                <small class="text-muted">Selamat mengajar, <?php echo $_SESSION['user_nama']; ?>!</small>
            </h1>
        </div>
    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php 
                                                ...
                                                echo $keterangan ? (strlen($keterangan) > 30 ? substr($keterangan, 0, 30) . '...' : $keterangan) : '-';
                                            ?>
                                        </td>
                                        <td>
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <i class="fas fa-bolt"></i> Akses Cepat untuk Guru
                    </h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            <button class="btn btn-warning w-100" onclick="showPanduan()">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                                <td><strong><?php echo $alat['nama_alat']; ?></strong></td>
                                <td><span class="badge bg-secondary"><?php echo $alat['kode_alat']; ?></span></td>
                                <td>
                                    <?php 
                                        $deskripsi = $alat['deskripsi'];
                                        echo $deskripsi ? (strlen($deskripsi) > 50 ? substr($deskripsi, 0, 50) . '...' : $deskripsi) : '-';
                                    ?>
                                </td>
                                <td>
...
function showPanduan() {
    alert('Panduan Peminjaman untuk Guru:\n\n1. Klik "Ajukan Peminjaman" untuk meminjam alat\n2. Pilih alat yang tersedia dan tentukan jumlah\n3. Isi tanggal pinjam dan kembali\n4. Berikan keterangan penggunaan\n5. Tunggu persetujuan dari admin lab\n6. Ambil alat di lab sesuai jadwal\n7. Kembalikan alat tepat waktu dan dalam kondisi baik');
}
</script>
